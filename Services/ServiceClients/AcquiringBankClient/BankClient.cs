...
namespace PaymentGateway.Services.ServiceClients
{
    ...
    public class BankClient : IBankClient
    {
        ...
        public async Task<Tuple<BankPaymentResponse,HttpStatusCode>> ProcessPayment(BankPaymentRequest request)
        {
            ...
            return new Tuple<BankPaymentResponse, HttpStatusCode>(response,httpResponse.StatusCode);
        }
    }
}
